#pragma checksum "C:\EX\BOIMVC\Views\MasterData\Shipto.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6bcc63ab4456ec2fb5682999133856a026bd3657"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6bcc63ab4456ec2fb5682999133856a026bd3657", @"/Views/MasterData/Shipto.cshtml")]
					...
					<div class=""tab-content"">
						<div class=""active tab-pane"" id=""shipperlist"">
							<table id=""tbl1"" class=""table table-bordered table-hover"">
								...
								<tbody>
");
            WriteLiteral(@"									<tr *ngFor=""let item of shiptolist; let i =index"">
										<td style=""width: 50px;text-align: center"">{{i+1}}</td>
										<td style=""width: 150px;text-align: center"">{{item.shipto}}</td>
										<td>{{item.company}}</td>
										<td>{{item.address}}</td>
										<td>{{item.taxid}}</td>
										<td>{{item.fullCompany}}</td>
            ...
            EndContext();
            BeginContext(2235, 2413, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c604231158ee4cf88570dcce153d7729", async() => {
                BeginContext(2265, 2376, true);
                WriteLiteral(@"
								...
								<div class=""form-group"">
									...
									<div class=""col-sm-8"">
										<input type=""text"" class=""form-control"" id=""shipper"" placeho");
                WriteLiteral(@"lder=""TAX ID"">
									</div>
								</div>
								<div class=""form-group"">
								...
								<div class=""form-group"">
									...
									<div class=""col-sm-8"">
										<input type=""");
                WriteLiteral(@"text"" class=""form-control"" id=""shipper"" placeholder=""FAX"">
									</div>
								</div>
	...
	<div class=""modal-dialog"">
		<div class=""modal-content"">
			...
			<div class=""modal-body"">
				");
            EndContext();
            BeginContext(5199, 2042, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0b2e848eabd74368a078e739f56879a1", async() => {
                BeginContext(5229, 2005, true);
                WriteLiteral(@"
					<div class=""form-group"">
						<label for=""inputName"" class=""col-sm-2 control-label"">Ship to</label>
						<div class=""col-sm-8"">
